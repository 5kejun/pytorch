...
class TestJit(TestCase):
    ...
    def test_compile_fuse_last_device(self):
        ...
        x = torch.tensor([0.4], requires_grad=True, dtype=torch.float, device=device)
        y = torch.tensor([0.7], requires_grad=True, dtype=torch.float, device=device)
    ...
    def checkTrace(self, func, reference_tensors, input_tensors=None,
        ...
        return ge # TODO TODO TODO TODO TODO TODO
